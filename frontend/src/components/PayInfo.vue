<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            PayInfo # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            PayInfo
        </v-card-title >
        ...
        <v-card-text>
            ...
            <String label="AccountNo" v-model="value.accountNo" :editMode="editMode"/>
        </v-card-text>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/payInfos'), this.value)
                        } else {
